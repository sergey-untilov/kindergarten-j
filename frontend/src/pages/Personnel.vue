  ...
  export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Hire Date', value: 'hireDate', align: 'right' },
    ...
    methods: {
      ...
      editItem (item) {
        ...
        this.editedIndex = this.$store.getters.employees.data.indexOf(item)
      ...
      deleteItem (item) {
        ...
        const index = this.$store.getters.employees.data.indexOf(item)
        // confirm('Are you sure you want to delete this item?') && this.desserts.splice(index, 1)
        confirm('Are you sure you want to delete this item?') && this.$store.getters.employees.data.splice(index, 1)
      },
